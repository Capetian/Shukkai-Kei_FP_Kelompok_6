...
<div class="container mt-5">
                    ...
                    <tbody class="th text-center">
                        ...
                        <tr>
                            <th scope="row" class="th text-justify"> 
                                <div class="col-5 ">
                                        <a href="{{url('ForumForum/subforum/show/') ~ subforum.id}}"><h5>{{ subforum.name }}</h5></a> 
    ...
    <div class="row-center ">
        <div class="col-md-auto bg-white ">
            <a href="{{url('ForumForum/subforum/index')}}">Browse Subforums >></a>
        </div>  
    </div>  
</div>
            ...
            <div class="text-center">
                <table class="table table-hover">
                    ...
                    <tbody class="th text-center">
                        ...
                        <tr>
                            <th scope="row" class="th text-justify"> 
                            <a href="{{url('ForumForum/thread/show/') ~ thread.id}}"><h5>{{ thread.title }}</h5></a> 
                            </th>
