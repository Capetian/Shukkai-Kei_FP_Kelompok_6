...
>
	...
	<!-- Nav Item - Forum Data -->
	<li class="nav-item">
		<a class="nav-link" href="{{ url('/Admin/index/forum') }}">
	...
	<!-- Nav Item - Changelog -->
	<li class="nav-item">
		<a class="nav-link" href="{{ url('/Admin/changelogs') }}">
	...
	<li class="nav-item">
		<a class="nav-link" href="{{ url('/Admin/moderator') }}">
			<i class="fas fa-fw fa-user-friends"></i>
	...
	<!-- Nav Item - Subforum -->
	<li class="nav-item">
		<a class="nav-link" href="{{ url('/Admin/subforum') }}">
	...
	<!-- Nav Item - Changelog -->
	<li class="nav-item">
		<a class="nav-link" href="{{ url('/Admin/thread') }}">
